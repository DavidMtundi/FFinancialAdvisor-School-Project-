                        ...
                        onPressed: () {
                          showDeleteConfirmationDialog<DialogAction>(
                              ...
                              child: AlertDialog(
                                  ...
                                  content: Text(
                                      'Are you sure you want to delete transaction "${widget.transaction!.description}" of ${widget.transaction!.amount.toMoney()}',
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            title: Text('${widget.transaction!.amount.toMoney()}'),
          ),
          ListTile(

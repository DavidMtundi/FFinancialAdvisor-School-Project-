                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        boxShadow: <BoxShadow>[
                          BoxShadow(
                              color:
                                  PiggyAppTheme.nearlyDarkBlue.withOpacity(0.4),
            ...
            child: Stack(
              ...
              children: <Widget>[
                ScaleTransition(
                  ...
                  child: IconToggle(
                    selectedColor: PiggyAppTheme.nearlyDarkBlue,
                    selectedIcon: widget.tabIconData!.iconData!,
                    unselectedIcon: widget.tabIconData!.iconData!,
                    selected: widget.tabIconData!.isSelected,
                  ),
                ),
                Positioned(
                  top: 4,
